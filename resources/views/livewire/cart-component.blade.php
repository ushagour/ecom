    ...
    <div class="container">
        ...
        <div class=" main-content-area">
                ...
                <ul class="products-cart">
                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="quantity">
                            ...
                            <p class="text-center">
                                <a href="" wire:click.prevent="switchToSaveForLater('{{ $item->rowId }}')">Save for
                                    Later</a>
                            </p>
                        </div>
            ...
            <div class="summary">
                <div class="order-summary">
                    ...
                    <p class="summary-info"><span class="title">Discount ({{ Session::get('coupon')['code'] }}) <a
                                href="#" wire:click.prevent="removeCoupon"><i class="fa fa-times text-danger"></i></a>
                    ...
                    <p class="summary-info"><span class="title">Total</span><b class="index"></span><b
            ...
            <div class="text-center" style="padding: 30px 0">
                ...
                <p>add item(s) now!</p>
                <a href="/shop" class="btn btn-danger" style=" background-color:#9f1a4e;">Shop Now</a>
            </div>
            @endif
                ...
                <div class="wrap-products">
                    <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5"
                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="#" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                    <figure><img src="{{ asset('assets/images/products/digital_6.jpg') }}" width="214"
                                            height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                </a>
                                <div class="group-flash">
                                    <span class="flash-item new-label">new</span>
                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="#" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                    <figure><img src="{{ asset('assets/images/products/digital_8.jpg') }}" width="214"
                                            height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                </a>
                                <div class="group-flash">
                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="#" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                    <figure><img src="{{ asset('assets/images/products/digital_2.jpg') }}" width="214"
                                            height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                </a>
                                <div class="wrap-btn">
                                    <a href="#" class="function-link">quick view</a>
