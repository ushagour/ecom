        ...
        <div class=" main-content-area">
                        ...
                        <div class="quantity">
                            <div class="quantity-input">
                                ...
                                <button class="btn btn-increase"
                                    wire:click.stopPropagation="increasequantity('{{$item->rowId}}')"></button>
            ...
            <div class="summary">
                ...
                <div class="update-clear">
                    <a class="btn btn-clear" href="#" wire:click.prevent="clearAll()">Clear Shopping Cart</a>
            ...
            <a href="/shop" class="btn btn-black">Shop Now</a>
            </div>
            @endif
