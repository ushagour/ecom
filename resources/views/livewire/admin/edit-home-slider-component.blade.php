<div>
    <section class="panel">
        ...
        <div class="panel-body">
            <form class="form-horizontal form-bordered" enctype="multipart/form-data" wire:submit="updateSlider">
                    ...
                    <div class="col-md-6">
                        <div class="fileupload fileupload-new" data-provides="fileupload">
                            <div class="input-append">
                                ...
                                {{-- handling the issus of temporaryUrl doesn't work when the instance is null  --}}
                                @if ($newimage)
                                <img src="{{$newimage->temporaryUrl()}}" alt="" width="120">
                                @else
                                <img src="{{ asset('assets/images/slider/'.$image)}}" alt="" width="120">
