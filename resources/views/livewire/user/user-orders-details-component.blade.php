        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <div class="row">
              ...
              <div class="col-md-6">
                <a href="{{ route('user.orders') }}" class="btn btn-danger pull-right">My Order(s)</a>
                @if ($order->status == 'ordered')
                  <a href="#" wire:click.prevent="cancelOrder" style="margin-right: 15px;" class="btn btn-success pull-right">Cancel Order(s)</a>
                @endif
              </div>
            </div>
          </div>
