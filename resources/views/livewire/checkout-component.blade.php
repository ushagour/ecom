			...
			<form wire:submit.prevent="placeOrder" autocomplete="off" onsubmit="$('#processing').show();">
						...
						<div class="wrap-address-billing">
							...
							<div class="billing-address">
								<p class="row-in-form">
									...
									<input type="text" name="fname" value="" placeholder="Your name" wire:model="firstname" autofocus>
									@error('firstname')
				...
				<div class="summary summary-checkout">
					<div class="summary-item payment-method">
						...
						@endif
						@if ($errors->isEmpty())
							<div id="processing" style="font-size: 20px; margin-bottom: 20px; padding-left: 35px; color: green; display: none;" wire:ignore>
